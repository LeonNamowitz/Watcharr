...
{#if (page.url?.pathname === "/" || page.url?.pathname.startsWith("/search") || page.url?.pathname.startsWith("/tag") || page.url?.pathname.startsWith("/lists") || page.url?.pathname.startsWith("/person")) && store.wlDetailedView && store.wlDetailedView.length > 0}
